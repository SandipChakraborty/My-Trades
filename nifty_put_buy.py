...
def buy_pe():
    # logger.info('nifty put buy started')
    nifty_atm_put = json.loads(util.get_nifty_atm_pe())
    # logger.info(nifty_atm_put)
    exchange = nifty_atm_put['exchange']
    symbol_token = nifty_atm_put['token']
